...
Add to `mcp_config.json` (use the correct path):
...
- Linux/Mac: `/home/mir/projects/docsplorer/server.py`
- Windows: `C:\Users\username\projects\docsplorer\server.py` (adjust as needed)
  ...
  "mcpServers": {
    "docsplorer": {
      ...
      "args": [
        ...
        "host",
        "--env-file",
        "/home/mir/projects/docsplorer/.env",
        "qdrant-mcp-server"
      ],
      "disabled": false
    }
